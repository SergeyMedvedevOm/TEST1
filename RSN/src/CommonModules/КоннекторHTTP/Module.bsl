...
Функция НовыеПараметры() Экспорт
	...
	//++ добавлено для Кафки. см. ПодготовитьЗапрос
	Параметры.Вставить("НеОбъединятьЗаголовки", Ложь);
	//--
...
Функция ПодготовитьЗапрос(Сессия, Метод, URL, ДополнительныеПараметры) Экспорт
	...
	Если ДополнительныеПараметры.Свойство("НеОбъединятьЗаголовки") И ДополнительныеПараметры.НеОбъединятьЗаголовки Тогда
		Заголовки = ЗаголовкиИзДополнительныхПараметров;
	Иначе
		Заголовки = Объединить(Скопировать(ЗаголовкиИзДополнительныхПараметров), Сессия.Заголовки);
	КонецЕсли;
	//--
