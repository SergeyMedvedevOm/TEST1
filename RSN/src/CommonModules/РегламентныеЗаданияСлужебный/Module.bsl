...
Функция ВыполнитьРегламентноеЗаданиеВручную(Знач Задание, ДопПараметрыЗадания = Неопределено) Экспорт
//-
	...
	Если ДопПараметрыЗадания = Неопределено = Ложь Тогда 
		Задание.Параметры[1].Вставить("ДопПараметрыЗадания", ДопПараметрыЗадания);
	КонецЕсли;
	//-
